...
public class SpringBootJdbcExampleApplication implements CommandLineRunner{
    ...
    void testStudentData() {
		...
		/*
		 * List<Student> students = Arrays.asList( new Student(1,"John", 16), new
		 * Student(2,"Martin", 18), new Student(3,"Mary", 20), new Student(4,"Ricky",
		 * 15) );
		 * 
		 * System.out.println("[SAVE]"); students.forEach(student -> {
        ...
        // update
        System.out.println("Update age of row 5 to 19");
        student.setAge(19);
        ...
        System.out.println("Rows affected: "+ studentService.deleteById(7));
